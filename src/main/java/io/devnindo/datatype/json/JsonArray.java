 ...
 * To enable JSON to be used easily in service code we use this class to encapsulate the notion of a JSON array.
 ...
 */
public class JsonArray implements Json, Iterable<Object> {
     ...
     *
     * @param byteData the byte buffer of JSON.
     */
    public JsonArray(byte[] byteData) {
        if (byteData == null) {
            throw new NullPointerException();
        }
        fromJson(new String(byteData, StandardCharsets.UTF_8));
    }
